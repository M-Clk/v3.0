        ...
        public List<string> CreateDb()
        {
            ...
            using (cmd = new SqlCommand())
            {
                ...
                foreach (var splitedScript in scripts)
                {
                    ...
                    {
                        if(!splitedScript.Replace(Environment.NewLine, "").StartsWith("Drop", StringComparison.InvariantCultureIgnoreCase))
